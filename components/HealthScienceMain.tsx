...
/**
 * Главное окошко «Здоровье и наука» на странице категории Здоровье и наука.
 * Внутри — окошки в том же стиле, что и на главной странице:
 * «Вспышки заболеваний, распространение вирусов», «Одобрение новых лекарств,
 * вакцин» — размытое фото-фон по названию и кнопка «Открыть» → страница прогноза.
 */
export default function HealthScienceMain({
  locale,
  dict,
  cards,
  cardLabels,
